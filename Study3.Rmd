...
#abs mean =  5.03, sd = 1.43, 192 
#flex mean =  4.08, sd = 1.42, 204
#pooled SD = sqrt(((1.43^2) + (1.42^2))/2)
sqrt((((1.43^2) + (1.42^2))/2)) #1.425009

#cohens = (mean - mean)/SD pooeld
(5.03-4.08)/1.425009 #0.67
...
d3 #Cohen's d abs. vs. flex. on morality (abs value)  = 0.67
```
...
#0 = verify, 1 = rely
table(s3$rv, s3$pref, s3$proclamation)
table(s3$rv, s3$pref)
