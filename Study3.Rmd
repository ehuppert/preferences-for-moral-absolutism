...
#Reported Models
#Model 1
rv.glm <- glm(rv_f ~ never + rarely + behavlie,
...
rv_test.glm <- glm(rv_f ~ never_f + rarely_f + behavlie_f + 
...
s3match <- s3[s3$pref >= 3, ]

#Dummy indicator for matching preferences
s3match$match <- ifelse((s3match$never==1 & s3match$pref==5) | (s3match$rarely==1 & s3match$pref==4) | (s3match$sometimes==1 & s3match$pref==3), 1, 0)
...
#Model 1
hypocrisy.lm1 <- lm(Hypocrisy_composite3 ~ never + rarely + match, data= s3match)
summary(hypocrisy.lm1)

#Model 2
hypocrisy.lm2 <- lm(Hypocrisy_composite3 ~ never + rarely + match
                   + rarely*match + never*match, data= s3match)
...
#Model 1
moral.lm1 <- lm(Moral_composite3 ~ never + rarely + match, data= s3match)
summary(moral.lm1)

#Model 2
moral.lm2 <- lm(Moral_composite3 ~ never + rarely + match
                   + rarely*match + never*match, data= s3match)
summary(moral.lm2)
...
#Model 1
honest.lm1 <- lm(Honest_composite3 ~ never + rarely + match, data= s3match)
summary(honest.lm1)

#Model 2
honest.lm2 <- lm(Honest_composite3 ~ never + rarely + match
                   + rarely*match + never*match, data= s3match)
summary(honest.lm2)
...
#Preferences Regression - Trust 
#Model 1
rv.glm <- glm(rv_f ~ never + rarely + match,
              data=s3match, family = binomial(link = "logit"))
summary(rv.glm)
...
#Model 3
rv.glm <- glm(rv_f ~ sometimes + match + 
                 sometimes*match,
              data=s3match, family = binomial(link = "logit"))
summary(rv.glm)

#Old Model
rv.glm <- glm(rv_f ~ sometimes*pref.center,
              data=s3, family = binomial(link = "logit"))
summary(rv.glm)

rv.glm <- glm(rv_f ~ never + rarely,
              data=s3, family = binomial(link = "logit"))
summary(rv.glm)

rv.glm <- glm(rv_f ~ never + rarely + pref.center + never*pref.center + rarely*pref.center,
              data=s3, family = binomial(link = "logit"))
summary(rv.glm)
