...
#just main effects
hypocrisy.lm2 <- lm(Hypocrisy_composite3 ~ sometimes + pref.center, data= s3)
summary(hypocrisy.lm2)

#Mean centered for reference
hypocrisy.lm3 <- lm(Hypocrisy_composite3 ~ sometimes*pref.center.2, data= s3)
...
summary(moral.lm)
#main effects
moral.lm2 <- lm(Moral_composite3 ~ sometimes + pref.center, data= s3)
summary(moral.lm2)

#Mean centered for reference
moral.lm3 <- lm(Moral_composite3 ~ sometimes*pref.center.2, data= s3)
summary(moral.lm3)
...
#Main effect
honest.lm2 <- lm(Honest_composite3 ~  sometimes + pref.center, data= s3)
summary(honest.lm2)

#Mean centered for reference
honest.lm3 <- lm(Honest_composite3 ~  sometimes*pref.center.2, data= s3)
summary(honest.lm3)
