...
#Logistic Regression
#Model 1
model1.trust_study5 <- glm(trustbeh ~ proclamation + order, data=s5, family = binomial(link = "logit"))
summary(model1.trust_study5)

#Model 2
model2.trust_study5 <- glm(trustbeh ~ proclamation*order, data=s5, family = binomial(link = "logit"))
summary(model2.trust_study5)
#1 = pass, 0 = keep
