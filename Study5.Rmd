...
s5 <- mutate(s5, Hypocrisy1_composite5 = ((s5$hypocrisy_1 + s5$hypocrisy_2 + s5$hypocrisy_4 + s5$hypocrisy_5)/4))
...
s5 <- mutate(s5, Honest_composite5 = ((s5$honest_freq_1 + s5$honest_likely_1 + s5$honest_extreme_1 + s5$committment_honesty_1)/4))
...
s5 <- mutate(s5, 
             Hypocrisy2_composite5 = (s5$hypocrisy_1.2 + s5$hypocrisy_2.2 + s5$hypocrisy_4.2 + s5$hypocrisy_5.2)/4)
...
s5 <- mutate(s5, Honest_composite5.2 = ((s5$honest_freq_2 + s5$honest_likely_2 + s5$honest_extreme_2 + s5$committment_honesty_2)/4))
...
Hypocrisy1_composite5 = hypocrisy composite of 4 items at timepoint 1 
Guilt_composite = guilt composite of 2 items at timepoint 1
Moral.1_composite5 = morality composite of 3 items at timepoint 1
Honest_composite5 = committment to honesty composite of 4 items at timepoint 1

Timepoint 2 (same 1-7 Likert-type scales):

Hypocrisy2_composite5  = hypocrisy composite of 4 items at timepoint 2
Guilt_composite = guilt composite of 2 items at timepoint 2
Moral.2_composite5 = morality composite of 3 items at timepoint 2
Honest_composite5.2 = committment to honesty composite of 4 items at timepoint 2
...
hypocrisy_df <-melt(s5, 
                ...
                measure.vars=c("Hypocrisy1_composite5","Hypocrisy2_composite5"),
...
t.test(absolute_s5$Hypocrisy1_composite5, absolute_s5$Hypocrisy2_composite5, paired = TRUE)
t_apa(t.test(absolute_s5$Hypocrisy1_composite5, absolute_s5$Hypocrisy2_composite5, paired = TRUE))
...
t.test(flexible_s5$Hypocrisy1_composite5, flexible_s5$Hypocrisy2_composite5, paired = TRUE)
t_apa(t.test(flexible_s5$Hypocrisy1_composite5, flexible_s5$Hypocrisy2_composite5, paired = TRUE))
...
hypo_honest5 <-melt(s5, 
                   id.vars=c("condition", "ID", "proclamation", "order"),
                   #measure command is for the DV
                   measure.vars=c("Honest_composite5","Honest_composite5.2"),
...
t.test(absolute_s5$Honest_composite5, absolute_s5$Honest_composite5.2, paired = TRUE)
t_apa(t.test(absolute_s5$Honest_composite5, absolute_s5$Honest_composite5.2, paired = TRUE))
...
t.test(flexible_s5$Honest_composite5, flexible_s5$Honest_composite5.2, paired = TRUE)
t_apa(t.test(flexible_s5$Honest_composite5, flexible_s5$Honest_composite5.2, paired = TRUE))
...
t.test(survey1_s5$Honest_composite5, survey1_s5$Honest_composite5.2, paired = TRUE)
t_apa(t.test(survey1_s5$Honest_composite5, survey1_s5$Honest_composite5.2, paired = TRUE))
...
t.test(game1_s5$Honest_composite5, game1_s5$Honest_composite5.2, paired = TRUE)
t_apa(t.test(game1_s5$Honest_composite5, game1_s5$Honest_composite5.2, paired = TRUE))
...
```{r}
#Logistic Regression
model.trust_study4 <- glm(trustbeh ~ proclamation*order, data=s5, family = binomial(link = "logit"))
