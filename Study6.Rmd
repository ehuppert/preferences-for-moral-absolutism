...
Now we lis the code for Pilot Study 3.
...
# Examine just first condition between-subjects
...
#absolute_first only includes Lie_stanabs
#relative_first only includes lie_rel_no media
