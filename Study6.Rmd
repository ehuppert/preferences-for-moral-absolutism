...
cp_omit_full$trust1 <- "NULL"
cp_omit_full$trust1 <- cp_omit_full$abtrust[cp_omit_full$lying_stance == "absolute_first"]
cp_omit_full$trust1 <-cp_omit_full$flextrust[cp_omit_full$lying_stance == "relative_first"]

p1c$lie[p1c$Q653 == "Lying is always okay."] <- "always"

cp_omit_full$trust1 <- 
  cp_omit_full$abtrust[CP$lyingstance == "absolute_first"]
cp_omit_full$trust1 <-
  cp_omit_full$flextrust[cp_omit_full$lyingstance == 'relative_first'] <- "flex"

cp_omit_full$trust1 <- "abtrust"[cp_omit_full$lyingstance == 'absolute_first']
cp_omit_full$trust1 <- "cp_omit_full$flextrust[cp_omit_full$lyingstance == 'relative_first']"
 
 
t.test(CP$trust1 ~ CP$lying_stance)
```
...
CP$trust1 <- NULL
CP$trust1 <- CP$abtrust[CP$lyingstance == "absolute_first"]
CP$trust1 <- CP$flextrust[CP$lyingstance == "relative_first"]
