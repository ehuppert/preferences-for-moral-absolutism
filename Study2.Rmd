...
#abs mean = 2.70, sd = 1.07, 83 
#flex mean =  2.39, sd = 1.10, 79
#pooled SD = sqrt(((1.07^2) + (1.10^2))/2)
sqrt((((1.07^2) + (1.10^2))/2)) #1.085

#cohens = (mean - mean)/SD pooeld
(2.70-2.39)/1.085104 #0.286

d2 <- cohens_d(t_test(Moral_composite2 ~ Proclamation, absflex_only)) 
#see Subset Data section below to exclude control
