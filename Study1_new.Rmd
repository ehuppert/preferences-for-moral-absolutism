...
s1 <- read.csv(here("HypocrisyStudy1_cleaned.csv")) #1205
...
psych::alpha(hypocrisy1_check.df) #alpha = 0.90
s1 <-  mutate(s1, 
...
psych::alpha(moral1_check.df) #alpha = 0.95
s1 <- mutate(s1, 
...
psych::alpha(honest1_check.df) #alpha = 0.76
s1<- mutate(s1, 
