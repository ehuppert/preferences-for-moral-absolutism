...
#Main effects
hypocrisy_4.lm2 <- lm(Hypocrisy_composite4 ~ sometimes + pref.center, data= s4)
summary(hypocrisy_4.lm2)

#Mean centered for reference
hypocrisy_4.lm3 <- lm(Hypocrisy_composite4 ~ sometimes*pref.center.2, data= s4)
...
moral_4.lm2 <- lm(Moral_composite4 ~ sometimes + pref.center, data= s4)
summary(moral_4.lm2)

#Mean centered for reference
moral_4.lm3 <- lm(Moral_composite4 ~ sometimes*pref.center.2, data= s4)
summary(moral_4.lm3)
...
#Main effects
honest_4.lm2 <- lm(Honest_composite4 ~ sometimes + pref.center, data= s4)
summary(honest_4.lm2)

#Mean centered for reference
honest_4.lm3 <- lm(Honest_composite4 ~ sometimes*pref.center.2, data= s4)
...
#Main effects
SI.lm2 <- lm(SI_composite4 ~ sometimes + pref.center, data= s4)
summary(SI.lm2)

#Mean centered for reference
SI.lm3 <- lm(SI_composite4 ~ sometimes*pref.center.2, data= s4)
summary(SI.lm3)
