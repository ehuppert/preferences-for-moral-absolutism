...
hypocrisy_4.lm <- lm(Hypocrisy_composite4 ~ sometimes + rarely + sometimes*pref.center + rarely*pref.center, data= s4)
...
moral_4.lm <- lm(Moral_composite4 ~ sometimes + rarely + sometimes*pref.center + rarely*pref.center, data= s4)
summary(moral_4.lm)
...
honest_4.lm <- lm(Honest_composite4 ~ sometimes + rarely + sometimes*pref.center + rarely*pref.center, data= s4)
summary(honest_4.lm)
...
SI.lm <- lm(SI_composite4 ~ sometimes + rarely + sometimes*pref.center + rarely*pref.center, data= s4)
summary(SI.lm )
